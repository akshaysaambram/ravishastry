            ...
            (image, index) =>
              index === currentIndex && (
                <motion.img
                  ...
                  className={cn(
                    "absolute z-10 rounded-[inherit] border border-gray-100 bg-linear-to-t from-neutral-100 to-white inset-shadow-sm inset-shadow-black/2 dark:border-zinc-900 dark:from-zinc-900 dark:to-zinc-800 dark:inset-shadow-white/7",
                    className,
                  )}
            ...
            (image, index) =>
              index === currentIndex && (
                <motion.div
                  ...
                  className={cn(
                    "rounded-full border border-gray-100 bg-linear-to-t from-neutral-100 to-white p-[15%] inset-shadow-sm inset-shadow-black/2 dark:border-zinc-900 dark:from-zinc-900 dark:to-zinc-800 dark:inset-shadow-white/7",
                    className,
                  )}
                >
                  <img
